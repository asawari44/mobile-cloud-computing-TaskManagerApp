...
public class ListOfProjectsDeadline extends AppCompatActivity implements MyRecyclerViewAdapter.RecyclerViewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_of_projects_deadline);
        ...
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.item2)
                {
                    Intent mainIntent=new Intent(ListOfProjectsDeadline.this,EditProfileActivity.class);
                ...
                else if(id==R.id.item3)
                {
                    ...
                    editor.clear();
                    editor.commit();
                    Intent mainIntent=new Intent(ListOfProjectsDeadline.this,LoginActivity.class);
                    mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(mainIntent);
                    finish();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(ListOfProjectsDeadline.this,CreateProject.class);
                mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(mainIntent);
            }
        });
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(ListOfProjectsDeadline.this,SearchActivity.class);
                mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(mainIntent);
        ...
        tabGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                {
                    Intent mainIntent=new Intent(ListOfProjectsDeadline.this,ListOfProjects.class);
                    startActivity(mainIntent);
                }
                else if (checkedId==R.id.radioButtonTab2)
                {
                    Intent mainIntent=new Intent(ListOfProjectsDeadline.this,ListOfProjectsStarred.class);
                    startActivity(mainIntent);
                }
            }
        });
    ...
    protected void onStart() {
        ...
        super.onStart();
        String url = "https://mcc-fall-2019-g03.appspot.com/user/projects?userId=" + userid + "&sortBy=deadline";
