...
public class RecyclerForMedia extends RecyclerView.Adapter<RecyclerForMedia.ViewHolder> {
    ...
    RecyclerForMedia(Context context,ArrayList<Pictures> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.media_holder_row, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
       ...
       // holder.picture.setImageBitmap();
        ...
        Glide.with(context).load(url).into(holder.MypictureView);
    }
