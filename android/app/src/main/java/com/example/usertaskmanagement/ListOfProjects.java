...
public class ListOfProjects extends AppCompatActivity implements MyRecyclerViewAdapter.RecyclerViewClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   profilePic.setImageResource(android.R.drawable.ic_dialog_email);
        // navigation through tabbed activities
        navView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                if(id==R.id.item2)
                {
                    Intent mainIntent=new Intent(ListOfProjects.this,EditProfileActivity.class);
                ...
                else if(id==R.id.item3)
                {
                    ...
                    editor.clear();
                    editor.commit();
                    Intent mainIntent=new Intent(ListOfProjects.this,LoginActivity.class);
                    mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(mainIntent);
                    finish();
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(ListOfProjects.this,CreateProject.class);
                mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(mainIntent);
            }
        });
        ...
        fab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent mainIntent=new Intent(ListOfProjects.this,SearchActivity.class);
                mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(mainIntent);
        ...
        tabGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                ...
                if(checkedId==R.id.radioButtonTab2)
                {
                    Intent mainIntent=new Intent(ListOfProjects.this,ListOfProjectsStarred.class);
                    startActivity(mainIntent);
                }
                else if (checkedId==R.id.radioButtonTab3)
                {
                    Intent mainIntent=new Intent(ListOfProjects.this,ListOfProjectsDeadline.class);
                    startActivity(mainIntent);
                }
                else if (checkedId==R.id.radioButtonTab1)
                {
                    onStart();
                }
            }
   ...
   public void onViewClicked(View v, int position) {
    ...
    protected void onStart() {
        ...
        super.onStart();
        String url = "https://mcc-fall-2019-g03.appspot.com/user/projects?userId=" + userid + "&sortBy=lastModified";
...
/*    private void showSearchDialog(final Intent mainIntent){
        AlertDialog.Builder searchDialog = new AlertDialog.Builder(this);
        searchDialog.setTitle("Search by:");
        String[] pictureDialogItems = {
                "Keyword",
                "Project Name" };
        searchDialog.setItems(pictureDialogItems,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                mainIntent.putExtra("searchtype","keyword");
                                startActivity(mainIntent);

                                break;
                            case 1:
                                mainIntent.putExtra("searchtype","name");
                                startActivity(mainIntent);
